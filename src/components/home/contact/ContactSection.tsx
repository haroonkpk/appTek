...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-16 px-4 sm:px-6 lg:px-20 bg-gray-50">
      {/* Heading */}
      ...
      {/* Layout */}
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
        <InfoCard />
        <ContactForm />
      </div>
    </section>
